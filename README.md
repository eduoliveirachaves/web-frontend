# 🛒 E-commerce - Programação para Web

Este repositório é referente ao front-end de um sistema de **E-commerce** desenvolvido para a disciplina de **Programação para Web**. O objetivo é aplicar conceitos de front-end modernos para criar uma aplicação funcional de compras online, utilizando o ecossistema Next.js.
