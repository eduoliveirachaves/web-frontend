...
export default function CheckoutPage() {
  ...
  const shipping = 15.00; // Frete fixo para exemplo
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-2/3 space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <h2 className="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">Dados de Entrega</h2>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input 
                    type="radio" name="paymentMethod" value="boleto"
              ...
              <div className="space-y-2 mb-4 max-h-60 overflow-auto pr-2">
                {cart.items.map(item => (
                  <div key={item.id} className="flex justify-between text-sm text-gray-600">
                    <span className="truncate w-2/3">{item.quantity}x {item.product.name}</span>
