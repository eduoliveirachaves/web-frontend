	...
	return (
		...
		>
			...
			<div className="relative w-full aspect-square bg-slate-50 p-6 flex items-center justify-center overflow-hidden">
				...
				{/* Hover da imagem pra ela "aumentar" */}
				<div
					className="absolute top-3 right-3 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-x-4 group-hover:translate-x-0">
					<button
						onClick={(e) => {
							e.preventDefault(); /* WISHLIST IMPLEMENTAR!!! */
						}}
          ...
          Esportes
				...
				<h3
					className="text-slate-800 font-medium text-base leading-snug mb-2 line-clamp-2 flex-grow group-hover:text-blue-600 transition-colors">
					{product.name}
				</h3>
            ...
            <span className="text-xs text-slate-400 line-through">
              ...
              {formatPrice(price)}
					...
					<button
						...
						className="p-3 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-sm hover:shadow-blue-200"
